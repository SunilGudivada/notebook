 ...
 * Example 1:
 *
 * Input: s1 = "ab" s2 = "eidbaooo" Output: True Explanation: s2 contains one permutation of s1
 * ("ba").
 *
 * Example 2:
 *
 ...
 * Constraints:
 *
 * The input strings only contain lower case letters. The length of both given strings is in
 * range [1, 10,000].
 */
